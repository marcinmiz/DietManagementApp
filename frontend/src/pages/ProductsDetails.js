...
export default function ProductsDetails (props) {
    ...
    const [state, setState] = React.useState({
        ...
        selected_product:[{product_id: 'new', product_name: "", product_image: "", product_category: "", product_author: "", product_favourite: false}],
        product_nutrients: [{nutrient_name: "Calories",nutrient_amount: 0, nutrient_unit: "kcal"}, {nutrient_name: "Protein", nutrient_amount: 0, nutrient_unit: "mg/100g"}, {nutrient_name: "Carbohydrates", nutrient_amount: 0, nutrient_unit: "mg/100g"}, {nutrient_name: "Fat", nutrient_amount: 0, nutrient_unit: "mg/100g"}, {nutrient_name: "Salt", nutrient_amount: 0, nutrient_unit: "mg/100g"}],
        product_ingredients: [],
        ...
        () => {
            ...
            if (product_id !== 'new'){
                ...
                setState({
                    ...state,
                    "mode": mode,
                    "selected_product": [{product_id: product_id, product_name: "Milk", product_image: red_apple, product_category: "Dairy", product_author: "Sara Bedrock", product_favourite: true}],
        ...
        if (state.mode === 'view') {
            current_product = <div id={state.selected_product[0].product_id} className="product product_selected">
                <div className="product_image_container product_selected_element ">
                    <img className="product_image" src={state.selected_product[0].product_image} alt={state.selected_product[0].product_name}/>
                </div>
